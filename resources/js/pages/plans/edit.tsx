...
export default function Edit({ status, plan }: EditPlanProps) {
    ...
    const { data, setData, put, processing, errors, reset } = useForm<Required<PlanForm>>({
        name: plan.name,
                                ...
                                <div className="grid gap-6">
                                    ...
                                    <div className="grid gap-2">
                                        ...
                                        <Input
                                            ...
                                            placeholder="How fast is the plan?"
                                        />
